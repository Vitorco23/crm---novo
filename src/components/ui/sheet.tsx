import { useMissionThemeClass } from "@/components/ui/mission-theme";
...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content ref={ref} className={cn(useMissionThemeClass(), sheetVariants({ side }), className)} {...props}>
        {children}
