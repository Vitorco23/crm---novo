...
const App = () => (<BrowserRouter>
    <Routes>
      ...
      <Route path="/lp01" element={<PublicRouteWrapper>
      ...
      <Route path="/*" element={<PublicRouteWrapper>
            <PrivateRouteWrapper>
              <Routes>
                ...
                <Route path="/inteligencia/metricas" element={<Suspense fallback={<div className="p-6 text-sm text-muted-foreground">Carregando Métricas…</div>}>
                ...
                <Route path="/saude-sistema" element={<Suspense fallback={<div className="p-6 text-sm text-muted-foreground">Carregando Saúde do Sistema…</div>}>
                    <SaudeSistema />
                  </Suspense>}/>
                <Route path="/laboratorio" element={<Suspense fallback={<div className="p-6 text-sm text-muted-foreground">Carregando Laboratório…</div>}>
