...
import caseEnergia from "@/assets/case-energia-solar.png.asset.json";
import caseAcademia from "@/assets/case-academia.png.asset.json";
import caseAcai from "@/assets/case-acai.png.asset.json";
