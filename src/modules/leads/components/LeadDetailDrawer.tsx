    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[80vw] w-[80vw] h-[85vh] p-0 gap-0 flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-border/60 bg-muted/20 flex items-center justify-end gap-3 shrink-0">
          <Button variant="ghost" onClick={() => onOpenChange(false)} className="font-bold text-xs h-9">Fechar</Button>
          <Button 
            className="h-9 bg-accent text-accent-foreground hover:bg-accent/90 font-black uppercase tracking-tight text-xs"
            onClick={() => {
