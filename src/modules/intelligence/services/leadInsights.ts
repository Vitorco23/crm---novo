...
import type { Lead, Interaction, CallNote } from "@/shared/services/store";
import { computeLeadTemperature, nextActionLabel, lastInteractionLabel } from "@/modules/cold-call/services/coldCallMetrics";
