...
import { getLeads, getMovementEvents, getSessions, getMeetings,
  type Lead, type MovementEvent, type PomodoroSession, type Meeting } from "@/shared/services/store";
import { getCallLogs, type CallLog } from "@/modules/knowledge/services/scripts";
import { getTransactions, type FinanceTransaction } from "@/modules/financeiro/services/finance";
import type { LabDateRange, LabFilters } from "@/modules/laboratorio/types/types";
