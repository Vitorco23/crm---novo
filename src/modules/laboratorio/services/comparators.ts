...
import type { Lead, MovementEvent, Meeting, PomodoroSession } from "@/shared/services/store";
import type { FinanceTransaction } from "@/modules/financeiro/services/finance";
import type { CallLog } from "@/modules/knowledge/services/scripts";
import type { LabDataset } from "@/modules/laboratorio/services/collector";
import { resolveSegments, parseNicheField, norm } from "@/modules/laboratorio/services/collector";
import type { Confidence, LabDimension, LabMetrics, RankingRow } from "@/modules/laboratorio/types/types";
